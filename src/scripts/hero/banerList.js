export const banerList = [
	{
		...
		backTexts: [
			...
			'Każde sushi tworzymy z pasją i dbałością o najmniejsze detale, by każdy kęs dostarczał Ci niezapomnianych wrażeń. Od tradycyjnych nigiri po kreatywne rolki fusion – znajdziesz coś idealnego dla siebie!',
			'Idealna okazja, aby spróbować naszych pysznych kompozycji i podzielić się nimi z bliskimi. Nabo Gato Sushi Bar – smakuj Wielkanoc w najlepszym wydaniu! 🍣✨ Zapraszamy do składania zamówień online lub odwiedzenia naszego lokalu, gdzie czeka na Ciebie wyjątkowa atmosfera i gościnność.',
			'Świętuj z nami i pozwól sobie na chwilę przyjemności z najlepszym sushi w mieście! 🎊🥢'
		]
	},
	{
		name: 'catering',
