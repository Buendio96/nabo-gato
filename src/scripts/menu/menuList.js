		...
		slides: [
			{
				...
				name: 'Tan Tan Men Ramen',
				price: '49,00 zł',
				description: 'gęsty, lekko pikantny bulion wołowo-drobiowy z orzechowo sezamową tare, pikantna wołowina, marynowane jajko, blanszowane pak choi, grillowane brązowe pieczarki, nori, olej chilli, makaron ramen',
				link: '#'
			},
			{
				image: image,
